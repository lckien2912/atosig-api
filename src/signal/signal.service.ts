...
export class SignalService {
    ...
    private mapToResponse(signal: Signal, currentUser?: any): SignalResponseDto {
        ...
        return {
            ...
            current_price: isGuest ? 0 : marketPrice,
            current_change_percent: isGuest ? 0 : signal.current_change_percent,
            ...
            entry_price: isGuest ? "***" : entryMin.toLocaleString(),
            entry_price_min: isGuest ? "***" : entryMin.toLocaleString(),
            entry_price_max: isGuest ? "***" : entryMax.toLocaleString(),
            entry_zone: isGuest ? "***" : `${entryMin.toLocaleString()} - ${entryMax.toLocaleString()}`,
            tp1: isGuest ? 0 : tp1,
            tp2: isGuest ? 0 : tp2,
            tp3: isGuest ? 0 : tp3,
            stop_loss_price: isGuest ? 0 : sl,
